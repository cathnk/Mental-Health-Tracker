...
class project:
    ...
    def __init__ (self, window):
        ...
        self.bttn = Button(self.label_main_page_first,image=self.imgn, command=self.test, bg="#98bffa", fg="white", border=0, font=("Sitka Small Semibold",25), activebackground="#98bffa")
    ...
    def register(self):
        def cek():
            def cek2():
                 ...
                 for akun in akun_pw:
                        ...
                        if ap[0] == a:
                            ...
                            self.bttn = Button(self.label_main_page_first, text="OK", border=0, bg="#d9d9d9", fg="navy", command=cek,font=("Sitka Small Semibold",13, 'bold'), activebackground="#d9d9d9")
            ...
            if c == True :
                ...
                self.bttn = Button(self.label_main_page_first, text="OK", border=0, bg="#d9d9d9", fg="navy", command=cekpw,font=("Sitka Small Semibold",13, 'bold'), activebackground="#d9d9d9")
                self.bttn.place(relwidth=0.04, relheight=0.04, relx=0.23, rely=0.51)
    ...
    def login(self):
        ...
        self.mainframe=Frame(self.window,bg='red')
        self.mainframe.place(x=0, y= 0)
        self.main_page_first = Image.open("C:/Project UAS TERBARU/Login.png")
        self.resize = self.main_page_first.resize((self.window.winfo_screenwidth(), self.window.winfo_screenheight()), Image.LANCZOS)
        self.main_page_first_read = ImageTk.PhotoImage(self.resize)
        self.label_main_page_first = Label(self.window, image=self.main_page_first_read)
        self.label_main_page_first.place(x=0, y=0, relwidth=1, relheight=1)
        ...
        toggle_btn.config(image=self.imgh)
        toggle_btn.place(x=1370, y=470, height=35)
    ...
    def wlcm(self):
        self.label_main_page_first.destroy()
        self.frm3=Frame(bg='red')
        self.frm3.pack(ipadx = 640, ipady = 360, expand = True)
        img = ImageTk.PhotoImage(Image.open("C:/Project UAS TERBARU/Username.png"))
        self.fm = Label(self.frm3, image=img)
        self.fm.image = img
        ...
        self.l1.place(x=910, y= 240)
        self.l1s = StringVar()
        self.l1e = Entry(self.fm, text=self.l1s, border=0, bg="white", fg="salmon", justify=CENTER, font=("Sitka Small Semibold",20, 'bold'))
        self.l1e.place(x=967, y=335, width=240, height=60)
        self.bttn = Button(self.fm, text="Next", bg="#d9d9d9", fg="salmon",activebackground="#d9d9d9", command=self.cn,  font=("Sitka Small Semibold",13, 'bold'), border=0, activeforeground="salmon")
        self.bttn.place(x= 1048, y=452, width=74, height=35)
    ...
    def mainmenu(self):
        self.frm3.destroy()
        self.frm4=Frame(bg='red')
        self.frm4.pack(ipadx = 640, ipady = 360, expand = True)
        mixer.init()
        mixer.music.load("C:/Project UAS TERBARU/Musik.mp3")
        mixer.music.play()
        img = ImageTk.PhotoImage(Image.open("C:/Project UAS TERBARU/Main Menu.png"))
        self.fm1 = Label(image=img)
        self.fm1.image = img
        self.fm1.pack(ipadx=1200, ipady=864)
        self.frame_l = Frame(bg="#c1f6fe")
        self.frame_l.place(x= 375, y= 55, width=550, height=100)
        self.frame_m = Frame(bg="white")
        self.frame_m.place(x= 500, y= 203, width=300, height=50)
    ...
    def test(self):  
        ...
        self.mainframe=Frame(self.window,bg='red')
        self.mainframe.place(x=0, y= 0)
        self.main_page_first = Image.open("C:/Project UAS TERBARU/Project UAS TERBARU/Halaman Tes Mental Health.png")
        self.resize = self.main_page_first.resize((self.window.winfo_screenwidth(), self.window.winfo_screenheight()), Image.LANCZOS)
        self.main_page_first_read = ImageTk.PhotoImage(self.resize)
        self.label_main_page_first = Label(self.window, image=self.main_page_first_read)
        self.label_main_page_first.place(x=0, y=0, relwidth=1, relheight=1)
        ...
        self.frame_1t.place(relwidth=0.25, relheight=0.1, relx=0.7, rely=0.76)
        self.frame_2t = Frame(self.label_main_page_first, bg="#473a5f")
        self.frame_2t.place(relwidth=0.25, relheight=0.1, relx=0.35, rely=0.76)
        self.frame_3t = Frame(self.label_main_page_first, bg="#473a5f")
        self.frame_3t.place(relwidth=0.25, relheight=0.1, relx=0.06, rely=0.76)
        self.frame_4t = Frame(self.label_main_page_first, bg="#c6f6ff")
        self.frame_4t.place(relwidth=0.5, relheight=0.13, relx=0.27, rely=0.03)
        self.t1 = Label(self.label_main_page_first, bg="#c1f3ff", fg="black", text=f"Haii Yuk Test Mental Health", font=("Sitka Small Semibold",30, 'bold'))
        self.t1.place(relwidth=0.6, relheight=0.1, relx=0.2, rely=0.08)
        self.button = Button(self.label_main_page_first, text="Mulai Tes Depresi", bg="#473a5f", fg="snow", command=lambda : self.soal(self.i), border=0, activebackground="#473a5f", font=("Sitka Small Semibold",28, 'bold'), activeforeground="snow")
        self.button.place(relwidth=0.25, relheight=0.1, relx=0.7, rely=0.76)
        self.button = Button(self.label_main_page_first, text="Mulai Tes Anxiety", bg="#473a5f", fg="snow", command=lambda : self.soal1(self.j), border=0, activebackground="#473a5f",activeforeground="snow", font=("Sitka Small Semibold",28, 'bold'))
        self.button.place(relwidth=0.25, relheight=0.1, relx=0.35, rely=0.76)
        self.button = Button(self.label_main_page_first, text="Mulai Tes Stress", bg="#473a5f", fg="snow", command=lambda : self.soal2(self.k), border=0, activebackground="#473a5f", font=("Sitka Small Semibold",28, 'bold'), activeforeground="snow")
        self.button.place(relwidth=0.25, relheight=0.1, relx=0.06, rely=0.76)
       
        self.imgt = ImageTk.PhotoImage(Image.open("C:/Project UAS TERBARU/Option.png"))
        self.fm2 = Frame(self.label_main_page_first, bg="#473a5f")
        self.fm2.place(x=0, y=0, width=1536, height=50)
        self.l11 = Label(self.label_main_page_first, text="Mental Health",bg="#473a5f", font=("Sitka Small Semibold",20, 'bold'), fg="white" )
        self.l11.place(relwidth=0.15, relheight=0.05, relx=0.77, rely=0.01)
        self.l112 = Label(self.label_main_page_first, text="Tracker",bg="#473a5f", font=("Sitka Small Semibold",20, 'bold'), fg="aqua" )
        self.l112.place(relwidth=0.08, relheight=0.05, relx=0.91, rely=0.01)
        self.imgic = PhotoImage(file="C:/Project UAS TERBARU/Icon.png")
        self.l1123 = Label(self.label_main_page_first, image=self.imgic, bg="#473a5f")
        self.l1123.place(relwidth=0.03, relheight=0.05, relx=0.745, rely=0.01)
        self.bttnsl = Button(self.label_main_page_first, image=self.imgt, bg="#473a5f",border=0, fg="salmon", command=self.nextf, activebackground="#473a5f")
        self.bttnsl.place(x= 10, y=7)
        # self.fr1 = Frame(self.label_main_page_first, bg="#67d4ff")
        # self.fr1.place(x=-320, y =0, width=320, height= 864)
        # self.imgbtest = ImageTk.PhotoImage(Image.open("C:/Project UAS TERBARU/Icon Test.png"))
        # self.bttnt = Button(self.label_main_page_first,  image=self.imgbtest, border=0, bg="snow",activebackground="snow", activeforeground="snow", fg="salmon",font=("Sitka Small Semibold",25, 'bold'))
        # self.bttnt.place(x=-80, y=150, width=400, height=85)
        # self.imghstry = ImageTk.PhotoImage(Image.open("C:/Project UAS TERBARU/Icon History.png"))
        # self.bttnh = Button(self.label_main_page_first, image=self.imghstry,border=0, bg="#67d4ff",activebackground="#67d4ff", activeforeground="snow", fg="salmon", command=self.backh, font=("Sitka Small Semibold",25, 'bold'))
        # self.bttnh.place(x= -57, y=250, width=400, height=85)
        # self.imgmn = ImageTk.PhotoImage(Image.open("C:/Project UAS TERBARU/Icon Home.png"))
        # self.bttnm = Button(self.label_main_page_first, image=self.imgmn, border=0, bg="#67d4ff", activebackground="#67d4ff", activeforeground="snow", fg="silver", font=("Sitka Small Semibold",25, 'bold'), command=self.backm)
        # self.bttnm.place(x= -68, y=50, width=400, height=85)
        # self.imgjrnl = ImageTk.PhotoImage(Image.open("C:/Project UAS TERBARU/Icon Jurnal.png"))
        # self.bttnj = Button(self.label_main_page_first, image=self.imgjrnl, border=0, bg="#67d4ff", activebackground="#67d4ff", activeforeground="snow", fg="salmon", font=("Sitka Small Semibold",25, 'bold'), command=self.backj)
        # self.bttnj.place(x= -65, y=350, width=400, height=85)
        # self.logout = ImageTk.PhotoImage(Image.open("C:/Project UAS TERBARU/Icon Logout.png"))
        # self.bttnl = Button(self.label_main_page_first, image=self.logout, border=0, bg="#67d4ff", activebackground="snow", activeforeground="snow", fg="salmon", command=self.exit1, font=("Sitka Small Semibold",25, 'bold'))
        # self.bttnl.place(x= -58, y=650, width=400, height=85)
        # self.imgbt= ImageTk.PhotoImage(Image.open("C:/Project UAS TERBARU/Slide Left.png"))
        # self.btnslb= Button(self.label_main_page_first, image=self.imgbt, bg="#67d4ff", fg="black", command=self.prevf, activebackground="#67d4ff", border=0).place(x=265, y=437)
