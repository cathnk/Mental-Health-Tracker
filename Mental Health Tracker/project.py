...
class project:
    ...
    def __init__ (self, window):
        ...
        img = ImageTk.PhotoImage(Image.open("C:/Project UAS TERBARU/Tampilan Awal.png"))
        ...
        self.soald = open("data_soald.txt", "r").read().split("\n")
        self.i = 0
        self.soalk = open("data_soalk.txt", "r").read().split("\n")
        self.j = 0
        self.soals = open("data_soals.txt", "r").read().split("\n")
        self.k = 0
    ...
    def register(self):
        ...
        self.data_akun = open("data_akun.txt",'a+')
        self.data_akun_r = open("data_akun.txt", 'r')
    ...
    def login(self):
        def masuk():
             def checkin(usr, pws):
                data_akun = open("data_akun.txt",'r').read().split('\n')
                a = 0
        ...
        self.frm.destroy()
        img = ImageTk.PhotoImage(Image.open("C:/Project UAS TERBARU/Login.png"))
    ...
    def mainmenu(self):
        ...
        self.l3 = Label(self.frame_m, text="Daily Motivation", bg="white", fg="black", justify=CENTER, font=("Sitka Small Semibold",22, 'bold'))
    ...
    def result(self):
        ...
        self.data_history = open("data_history.txt", "a")
    ...
    def result1(self):
        ...
        self.data_history1 = open("data_history1.txt", "a")
    ...
    def result2(self):
        self.fts.destroy()
        # global data_history_text
        self.data_history2 = open("data_history2.txt", "a")
